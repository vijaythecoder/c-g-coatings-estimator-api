...
This is the project charter for the C&G estimator  project.
This application will be delivered as a  application. (e.g. web, iOS, Android)

- [View Published Version](https://github.com/vijaythecoder/c-g-coatings-estimator-api)
...
## Project Purpose
The main purpose of this project is to build a mobile app that quickly estimate and quote job costs. The app needs to be fast and easy for a non-technical client. The app should do and can provide all calculations required.
...
This application is used by only one types of users.
